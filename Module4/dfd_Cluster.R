dfd_Cluster <- function(genome_cover_percentage,avg_dfd_length,avg_genes_per_dfd, tot_chrom_cover_percentage, categories_index, plot_path, xgboost = 0, tsne = 0, dfds_overlap = 0)
{
  ...
  if(xgboost == 0)
  {output <- list(cluster_genome_cover = cluster_genome_cover, cluster_chromosome_cover = cluster_chromosome_cover)}
  return(output)
}
